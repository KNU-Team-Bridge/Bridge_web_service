...
function MainPage() {
  ...
  useEffect(() => {
    ...
    const observerCenter = new IntersectionObserver(handleIntersectionCenter, options);
    const observerInfo1 = new IntersectionObserver(handleIntersectionInfo1, options);
    const observerInfo2 = new IntersectionObserver(handleIntersectionInfo2, options);
    ...
    <div>
      ...
      <div className='body'>
        <div className='intro'>
          <div className='intro-left'>
            ...
            <div className='intro-subtitle'>청각장애인과 소통할 수 있는 화상회의 서비스</div>
        ...
        <div className='info'>
          <div ref={targetRefInfo1} className={`info-1 ${isInfo1Visible ? 'visible' : ''}`}>
            ...
            <div className='img-div1'>
              <img className='communication-image' src={Communication} alt='communication.png' />
            </div>
          </div>
          <div ref={targetRefInfo2} className={`info-2 ${isInfo2Visible ? 'visible' : ''}`}>
            ...
            <div className='img-div2'>
              <img className='computer-image' src={Computer} alt='computer.png' />
            </div>
          </div>
        </div>
        <div className='manual'>
          <div ref={targetRefLeft} className={`left ${isLeftVisible ? 'visible' : ''}`}>
            <div className='left-up'>
              <div className='img-hand'>
                <img className='hand-img' src={Hand} alt='hand.png' />
              </div>
              <div className='arrow1'>
                <img className='right-arrow' src={rightArrow} alt='right-arrow.png' />
              </div>
            </div>
          ...
          <div ref={targetRefCenter} className={`center ${isCenterVisible ? 'visible' : ''}`}>
            <img src={Message} alt='message.png' className='messageImage' />
          </div>
          <div ref={targetRefRight} className={`right ${isRightVisible ? 'visible' : ''}`}>
            <div className='right-up'>
              음성으로 말하면 문장이<br></br>메세지로 전달되게 됩니다
            </div>
            <div className='right-down'>
              <div className='arrow2'>
                <img className='left-arrow' src={leftArrow} alt='left-arrow.png' />
              </div>
      ...
      <div className='end'>
        <div className='end-center'>
          ...
          <div className='down'>
            <div className='down-up'>브릿지팀 | 053-950-5550 | bridge@knu.ac.kr</div>
            <div className='down-center'>41566 대구광역시 북구 대학로 80 / IT대학 융복합관 317호(건물번호 : 415)</div>
            <div className='down-down'>ⓒ 2023 BridgeTeam, Inc. All rights reserved.</div>
          </div>
        </div>
      </div>
    </div>
